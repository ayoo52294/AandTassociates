            ...
            <div className="visionary-grid">
                ...
                <div className="founder-card">
                    ...
                    <div className="social-iconst">
                        ...
                        <a href="https://x.com/AyomidePet60412" aria-label="Twitter" target="_blank" rel="noopener noreferrer"><FaTwitter /></a>
                        <a href="https://www.linkedin.com/in/ayomide-peter-oke-483420273" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer"><FaLinkedinIn /></a>
                        <a href="#" aria-label="Instagram" target="_blank" rel="noopener noreferrer"><FaInstagram /></a>
                        <a href="https://github.com/ayoo52294" aria-label="Github" target="_blank" rel="noopener noreferrer"><FaGithub /></a>
                        <a href="#" aria-label="Whatsapp" target="_blank" rel="noopener noreferrer"><FaWhatsapp /></a>
                        <a href="#" aria-label="Website" target="_blank" rel="noopener noreferrer"><FaLink /></a>
                ...
                <div className="founder-card">
                    ...
                    <div className="social-iconst">
                        <a href="https://www.facebook.com/JejeTimmy" aria-label="Facebook" target="_blank" rel="noopener noreferrer"><FaFacebookF /></a>
                        <a href="https://x.com/ExecTimmy?t=UuormOoLTiUo81b7Y3Lgfg&s=09" aria-label="Twitter" target="_blank" rel="noopener noreferrer"><FaTwitter /></a>
                        <a href="https://www.linkedin.com/in/jeje-timmy-9b011b2a7" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer"><FaLinkedinIn /></a>
                        <a href="https://www.instagram.com/exectimmy" aria-label="Instagram" target="_blank" rel="noopener noreferrer"><FaInstagram /></a>
                        <a href="#" aria-label="Github" target="_blank" rel="noopener noreferrer"><FaGithub /></a>
                        <a href="https://wa.me/2347045136425" aria-label="Whatsapp" target="_blank" rel="noopener noreferrer"><FaWhatsapp /></a>
                        <a href="#" aria-label="Website" target="_blank" rel="noopener noreferrer"><FaLink /></a>
                        <a href="#" aria-label="Telegram" target="_blank" rel="noopener noreferrer"><FaTelegramPlane /></a>
